...
const char* ssid = "Dinh";      //--> Enter your SSID / your WiFi network name.
const char* password = "20181015";  //--> Enter your WiFi password.
/* ======================================== */

/* ======================================== Variables for telegram bot tokens. */
String BOTtoken = "8093940639:AAGXIoQFJhTpS5MaYe4Jqh7EtquxJr36iIU";  //--> your Bot Token (Get from Botfather).
/* ======================================== */

/* ======================================== @myidbot ID */
// Use @myidbot to find out the chat ID of an individual or a group.
// Also note that you need to click "start" on a bot before it can message you.
String CHAT_ID = "7829051112";
/* ======================================== */
